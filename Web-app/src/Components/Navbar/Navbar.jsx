        ...
        <div className="navbar-container d-flex justify-content-between align-items-center">
          ...
          <nav className={`navbar-links ${isOpen ? 'open' : ''}`}>
            <ul className='navbar-nav d-flex flex-row flex-lg-row'>
              <li><a href="#" className='nav-link text-black'>HOME</a></li>
              <li><a href="#" className='nav-link text-black'>ABOUT</a></li>
              <li><a href="#" className='nav-link text-black'>PORTFOLIO</a></li>
              <li><a href="#" className='nav-link text-black'>TEAM</a></li>
              <li><a href="#" className='nav-link text-black'>CONTACT</a></li>
            </ul>
          </nav>
        </div>
